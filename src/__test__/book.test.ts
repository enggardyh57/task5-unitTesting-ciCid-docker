...
describe("Book API", () => {
  ...
  const validToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImVuZ2dhcmR5YWgiLCJpYXQiOjE3MzA3ODQwMjMsImV4cCI6MTczMDc4NzYyM30.XDG_E4TnyVh3QWXcf3UANCxMV-X7fnh_vQhGw1pbavo"; 
