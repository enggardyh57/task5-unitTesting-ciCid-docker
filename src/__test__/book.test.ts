...
describe("Book API", () => {
  ...
  const validToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImVuZ2dhcmR5YWgiLCJpYXQiOjE3MzA4MDMxMzIsImV4cCI6MTczMDgwNjczMn0.eiCMzNAsGJh0slDEeVtCzr1qbbdrt8bhdM1ggyhIYOs"; 
